                    ...
                    {stage === 'entry' && (
                        <div className="rounded-2xl bg-slate-800/80 backdrop-blur-2xl border border-slate-700/60 shadow-2xl overflow-hidden">
                            ...
                            <div className="px-8 py-10">
                                ...
                                {/* Google */}
                                <button disabled className="w-full flex items-center justify-center gap-3 rounded-xl bg-slate-700/40 border border-slate-600/40 px-4 py-3.5 text-slate-500 font-semibold cursor-not-allowed text-sm">
                                    <GoogleIcon />
                                    Continue with Google
                                    <span className="ml-auto rounded-md px-2 py-0.5 text-[10px] bg-slate-700 text-slate-500 font-medium border border-slate-600/50">
                                        Soon
                                    </span>
                                </button>
